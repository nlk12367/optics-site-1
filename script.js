    ...
    "problems": {
        html: `
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-3-1">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-3-1">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-3-25">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-3-25">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-3-26">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-3-26">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-3-27">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-3-27">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-3-28">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-3-28">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-3-31">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-3-31">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-3-32">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-3-32">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-4-52">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-4-52">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-4-53">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-4-53">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-4-54">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-4-54">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-4-55">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-4-55">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-4-57">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-4-57">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-4-58">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-4-58">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-7-5">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-7-5">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-7-7">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-7-7">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-7-9">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-7-9">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-7-10">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-7-10">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-1">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-1">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-2">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-2">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-3">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-3">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-4">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-4">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-5">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-5">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-7">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-7">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-8">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-8">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-9">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-9">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-10">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-10">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-11">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-11">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-20">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-20">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-21">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-21">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-22">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-22">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-27">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-27">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-28">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-28">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-39">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-39">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-43">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-43">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-44">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-44">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-45">顯示/隱場解答</button>
                <div class="solution-content" id="sol-8-45">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-46">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-46">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-47">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-47">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-56">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-56">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-57">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-57">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-58">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-58">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-59">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-59">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-60">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-60">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-61">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-61">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-65">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-65">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-66">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-66">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-75">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-75">
            ...
            <section class="learning-module">
                ...
                <button class="solution-toggle-btn" data-target="sol-8-76">顯示/隱藏解答</button>
                <div class="solution-content" id="sol-8-76">
                    <img src="https://hackmd.io/_uploads/BkL2JwM1Zx.png" alt="Problem 8.76 Solution">
                </div>
            </section>
        `,
        // --- 習題頁面會使用通用的 solution toggle 邏輯 ---
        initLogic: () => {
            // 呼叫通用的解答切換功能
            initSolutionToggles();
        }
...
function initSolutionToggles() {
    const allToggleButtons = document.querySelectorAll('.solution-toggle-btn');
